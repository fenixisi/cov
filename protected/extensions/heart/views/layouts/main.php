			...
			'items'=>array(
				array('label'=>'', 'url'=>'#', 'icon'=>'fa fa-user', 'visible'=>!Yii::app()->user->isGuest, 'items'=>array(
					array('label'=>'Logout ('.Yii::app()->user->name.')', 'url'=>array('site/logout'), 'icon'=>'fa fa-power-off',),
                                        array('label'=>'Mi Perfil ('.Yii::app()->user->name.')', 'url'=>array('site/logout'), 'icon'=>'fa fa-user',),
				)),
			),
		),
	),
...
<?php
$this->widget('bootstrap.widgets.TbNavbar', array(
	'brand' => '<small>Centro Oftalmologico Viscarra    Copyright &copy; 2014 by Hafid Mukhlasin-Adaptado por  Felix Ariel Ureña Solis.</small>',
	'fixed' => 'bottom',
	'type' => 'inverse',
));
?>
