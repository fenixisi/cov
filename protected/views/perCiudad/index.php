...
$this->menu=array(
	array('label'=>'PerCiudad','url'=>array('index'),'icon'=>'fa fa-list-alt', 'items' => $menu)	
);
...
Yii::app()->clientScript->registerScript('search', "
	...
	$('.search-form form').submit(function(){
		$.fn.yiiGridView.update('per-ciudad-grid', {
			data: $(this).serialize()
		});
		return false;
	});
...
Yii::app()->clientScript->registerScript('refreshGridView', "
	...
	//setInterval(\"$.fn.yiiGridView.update('per-ciudad-grid')\",5000);
");
