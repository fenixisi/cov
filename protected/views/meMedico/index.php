...
$this->menu=array(
	array('label'=>'MeMedico','url'=>array('index'),'icon'=>'fa fa-list-alt', 'items' => $menu)	
);
...
Yii::app()->clientScript->registerScript('search', "
	...
	$('.search-form form').submit(function(){
		$.fn.yiiGridView.update('me-medico-grid', {
			data: $(this).serialize()
		});
		return false;
	});
...
Yii::app()->clientScript->registerScript('refreshGridView', "
	...
	//setInterval(\"$.fn.yiiGridView.update('me-medico-grid')\",5000);
");
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
		array(
	        'name'=> 'pk_id_medico',
	        'value' => '($data->pk_id_medico)',
	        'headerHtmlOptions' => array('style' => 'text-align:center;'),
	    ),
		
		array(
	        'name'=> 'fk_personal',
	        'value' => '($data->fk_personal)',
	        'headerHtmlOptions' => array('style' => 'text-align:center;'),
	    ),
		
		array(
	        'name'=> 'fk_titulo',
	        'value' => '($data->fk_titulo)',
	        'headerHtmlOptions' => array('style' => 'text-align:center;'),
	    ),
