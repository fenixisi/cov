...
<?php $box = $this->beginWidget(
    ...
    array(
        'title' => 'Personal Sin Acceso al sistema Viscarra',
	...
	'columns'=>array(						
	    ...
	    array(
			...
			'buttons'=>array
                        (
                            'Activar' => array(
                                'label'=>'Re-Activar Usuario', 
                                'url'=>"CHtml::normalizeUrl(array('/SeSesionUsuario/activar', 'id'=>\$data->pk_id_usuario))",
                                'icon'=> ' fa fa-check',
                            ),   
                        )
		),
