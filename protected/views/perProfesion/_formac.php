...
<?php echo $form->radioButtonListRow($model,'estado', array('0'=>'Ocupacion ', '1'=>'Profesion '),array('class'=>'row1')); ?>
...
<div class="form-actions">
    ...
    <?php echo CHtml::link('Cancelar',array('admin'),array('class'=>'create-button btn btn-danger','title' => 'Cancelar Actualizacion de Datos de Profesion / Ocupacion')); ?>
</div>
