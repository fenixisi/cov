...
<?php echo $form->textFieldRow($model,'fecha_creacion',array('class'=>'span5','value'=> $fech, 'readonly'=>'false')); ?>
...
<div class="form-actions">
	<?php $this->widget('bootstrap.widgets.TbButton', array(
        ...
        <?php echo CHtml::link('Cancelar',array('admin'),array('class'=>'create-button btn btn-danger','title' => 'Cancelar Registro de Datos del Catalogo del Sistema', 'icon' => 'icon- fa fa-list-alt')); ?>
</div>
