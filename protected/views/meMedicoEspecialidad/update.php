...
$this->breadcrumbs=array(
	'Medico Especialidad'=>array('index'),
	$model->pk_id_medico_especialidad=>array('view','id'=>$model->pk_id_medico_especialidad),
	'Actualizar',
);
...
<?php $box = $this->beginWidget(
    ...
    array(
        'title' => 'Actualizar Datos de Especialidad de Medico #'.$model->pk_id_medico_especialidad,
